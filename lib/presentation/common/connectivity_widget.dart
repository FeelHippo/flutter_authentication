...
class ConnectivityWidgetState extends State<ConnectivityWidget> {
  ...
  Future<void> checkConnectivity() async {
    final List<ConnectivityResult> results = await widget.connectivity.checkConnectivity();
    _updateSnackBarState(results);
    _subscription ??= widget.connectivity.onConnectivityChanged.listen(_updateSnackBarState);
  }
